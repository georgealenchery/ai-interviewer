...
import { signup, signInWithGoogle, signInWithGitHub } from "../services/auth";
        ...
        <div className="backdrop-blur-lg bg-white/40 rounded-3xl p-8 border border-white/50 shadow-xl">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-white/40 px-3 text-gray-500">or continue with</span>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 rounded-xl border border-white/60 bg-white/60 px-4 py-3 text-sm font-medium text-gray-700 shadow-sm backdrop-blur-sm transition-all hover:bg-white/80"
            >
